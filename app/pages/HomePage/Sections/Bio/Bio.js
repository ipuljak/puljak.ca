                    ...
                    <div className="bio-content">
                        ...
                        <div className="bio-text">
                            <p>Hello, my name is Ivan, and welcome to my personal website! This site more or less
                                ...
                                engineering full stack web applications and other software solutions. I mostly work with
                            ...
                            <p>I went to school at the University of Toronto and in 2014 I graduated with an Honours
                                ...
                                and later supervisor for a company called Arctic Glacier. I would later voluntarily
                                leave to focus on expanding my abilities as a software developer.</p>
                            ...
                            <p>In April of 2017, I started my career in technology after being hired as a software
                                ...
                                the entire stack, which includes JavaScript/React front-end, Grails/Groovy back-end, and
                                dev-ops using many of the Amazon Web Services tools.</p>
                            ...
                            <p>A year later I was promoted to UI Lead, where I was given full responsibility for
                                ...
                                summer I built an Originality Checker written in Python and deployed on it's own Flask
                                server as a microservice. In the future I look forward to working on topic modelling,
                                sentiment analysis, and much more.</p>
                            ...
                            <p>My passion for helping others stretches beyond what I've outlined on my website, with a
                                ...
                                of my community is the best way to lead a fulfilling life.</p>
